...
export default function ViewPage() {
  ...
  const metrics = data
    ...
    : {
        daily: { totalComments: 0 },
        monthly: { totalComments: 0 },
        allTime: { totalComments: 0 },
      };
    ...
    <div className="min-h-screen flex flex-col items-center justify-start p-6">
      ...
      {/* // Top box */}
        <div className="w-full text-center mb-8 py-6 p-9 px-6 bg-gray-100 rounded-lg shadow-md">
          <h1 className="text-2xl font-bold text-purple-500">Comment Details</h1>
          <p className="text-lg text-gray-600 mt-4">
            Check out total number of comments on your post and their metrics. Select a time period (Daily, Monthly, All-Time) to explore the data.
          </p>
        </div>
        ...
        <div className="flex flex-col items-center justify-center space-y-6 md:space-y-6 ">
          ...
          <div className="w-full md:w-auto bg-white shadow-md p-6 rounded flex flex-col justify-center">
            {loading ? (
              ...
              <>
              {/* End box */}
                <h2 className="text-lg font-semibold text-purple-400">Total Comments</h2>
                <p className="text-3xl font-bold text-yellow-400">
                  {metrics[selectedPeriod].totalComments || 0}
                </p>
              </>
            )}
          </div>
